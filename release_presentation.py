...
import release_repository as _r

_r.ET = ET
_RELEASE_VERSION = '4.9.0'
...
_FLIGHT_PACK = {
    ...
    'plugin.program.autocompletion': 'https://download.kodi.tv/addons/omega/plugin.program.autocompletion/plugin.program.autocompletion-2.1.2.zip',
}
...
def _patch_builder(frame, event, arg):
    ...
    if callable(generate_userdata) and not _builder_state['userdata']:
        ...
        def generate_unified_userdata():
            ...
            print('DragonMax 4.9 presentation layer staged with custom Home.xml and realm controls')
