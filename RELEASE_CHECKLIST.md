...
DragonMax V12 4.5.0 ships only when source, generated artifacts, Render deployment, and Fire TV/Kodi device validation all pass. Package size is secondary to stability and clean launch behavior.
...
- [ ] Repository, wizard, and build versions all equal 4.5.0.
